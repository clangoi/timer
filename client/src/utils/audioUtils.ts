export class AudioManager {
  ...
  async playCountdownSound(secondsRemaining: number) {
    ...
    switch (secondsRemaining) {
      case 3:
        await this.playTone(600, 0.15); // Tono de 600 Hz para 3
        break;
      case 2:
        await this.playTone(600, 0.15); // Tono de 600 Hz para 2
        break;
      case 1:
        await this.playTone(600, 0.2); // Tono de 600 Hz para 1 (más largo)
        break;
      default:
        break;
    }
