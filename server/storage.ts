...
export interface IStorage {
  ...
  updateTabataSet(id: number, updates: Partial<TabataSet>): Promise<TabataSet | undefined>;
  deleteTabataSet(id: number): Promise<boolean>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateTabataSet(id: number, updates: Partial<TabataSet>): Promise<TabataSet | undefined> {
    const [tabataSet] = await db
      .update(tabataSets)
      .set({
        ...updates,
      ...
      .where(eq(tabataSets.id, id))
      .returning();
    return tabataSet || undefined;
  }

  async deleteTabataSet(id: number): Promise<boolean> {
